...
<iframe width="560" height="315" src="https://www.youtube.com/embed/r1_Fba8YpHE" frameborder="0" gesture="media" allowfullscreen></iframe>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="heading">
                        ...
                        <p class="heading-text">For proof of the economic power of Internet marketing, look no further than the trend of massive Internet business buy-outs. Companies that don't even have brick-and-mortar offices are absorbed by major corporations like Google, Yahoo!, Facebook, and Microsoft for millions of dollars every year.
                        </p>
                    </div>
                    ...
                    <ul class="list list--secondary">
                        <li>
                            ...
                            <a href="#">Pay-per-click (PPC) is a method of purchasing targeted advertising space on Internet platforms that takes advantage of organic search terms. </a>
                        </li>
                        <li>
                            <i class="seoicon-check"></i>
                            <a href="#">Business owners are attracted to pay-per-click marketing because it can be highly effective at a low cost.</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Increase Engagement through High Impact Video Advertising. Capture the attention of your target audience through video advertising.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Remarketing helps you reach people who have visited your website or used your app. Previous visitors or users can see your ads as they browse websites.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Social advertising is advertising that relies on social information or networks in generating, targeting, and delivering marketing communications.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="info-box--standard">
                ...
                <div class="info-box-content">
                    ...
                    <p class="text">Display advertising is advertising on websites. It includes many different formats and contains items such as text, images, flash, video, and audio. 
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="heading">
                    ...
                    <a href="11_case_studies.html" class="read-more">See All Projects
                        <i class="seoicon-right-arrow"></i>
                    </a>
                    <div class="heading-line">
                        <span class="short-line"></span>

    ...
    <div class="stunning-header-content">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs-item active">
                <span href="#">Yoda Medical HomePage EXCLUSIVE PRESTASHOP THEME </span>
                <i class="seoicon-right-arrow"></i>
            </li>
        </ul>
    </div>
                    ...
                    <div class="swiper-container" data-effect="fade">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="product-details-img-wrap swiper-slide">
                                <img src="img/product-details9.png" alt="product" data-swiper-parallax="-10">
...
<a href="http://teampresta.com/demothemes/?theme=Yoda5" class="btn btn-medium btn--primary">
...
<div class="info-box-image">
                    ...
                    <h3 class="product-details-info-title"> Yoda Medical Prestashop Theme</h3>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/fY5hE55HlfQ" frameborder="0" allowfullscreen></iframe>
<p>Nowadays, customers prefer getting items online, even drugs. Not many people fancy the idea of going to a drug store across the street, much less when the shop is far away inside the city. Buying drugs from medical websites means customers will have access to greater assortment of medicines to choose from and they can even buy drugs outside their cities. That is why it is paramount for shop owners to implement the best designs that will rightly display their products on the web.</p>
<p>Are you looking for the perfect digital solution for your medical shop? Do you want to create a drug store with a quality theme that truly represents your trade? If so, then Yoda Medical by Prestashop might just be what you need. With this theme, you don’t need to wreck your wallet to hire a developer to make a new website for you.</p>
<p>YodaMedical is a responsive PSD HTML theme that remains one of the best solutions for building fantastic medical websites with effective ecommerce features. While it is specially designed for pharmacists who want to create online versions of their physical shops, it can be used by clinics, hospitals, surgeons, doctors, veterinarians and other professionals involved in medicine. Some of the features that makes it superior to many other medical themes out there includes; quick product view; impressive Mega menu and headers; search engine optimized; fast experience and user-friendly; stylish retina ready graphics; social media integration; contact form; search button and placeholder to look up any particular item; newsletter subscription form; widgets; and more. </p>
...
<div class="skills">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="product-reviews">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="product-description-title">3 Reviews for “<span class="c-primary">Yoda Medical Prestashop Theme </span>”</div>

...
<head lang="en">
    ...
    <title>Seosight - Product Details</title>
            ...
            <div class="header-content-wrapper">
                ...
                <nav id="primary-menu" class="primary-menu">
                    ...
                    <ul class="primary-menu-menu">
                        ...
                        <li class="">
                            <a href="03_services.html">Prestashop Themes</a>
                            <ul class="dropdown">
                        ...
                        <li class="">
                            <a href="http://trafficvirals.com/blog/">Blog</a>
                        </li>
        ...
        <div class="product-details">
                    ...
                    <div class="swiper-container" data-effect="fade">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="product-details-img-wrap swiper-slide">
                                <img src="img/product-details4.png" alt="product" data-swiper-parallax="-10">
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    <div class="product-details-info-price"><span class="del"> $23.99 </span>$16.99</div>
                    <h3 class="product-details-info-title">SEO: Marketing Strategy</h3>
        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">TEAMPRESTA Company!</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>

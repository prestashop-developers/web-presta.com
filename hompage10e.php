    ...
    <div class="stunning-header-content">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs-item active">
                <span href="#">YodaJewellery HomePage EXCLUSIVE PRESTASHOP THEME </span>
                <i class="seoicon-right-arrow"></i>
            </li>
        </ul>
    </div>
        ...
        <div class="product-details">
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    <div class="product-details-info-price"><span class="del"> $79.99 </span>$69.99</div>
<div class="product-details-info-price"><span class="author-name">Release date : </span>20 March, 2017</div>
...
<div class="info-box-image">
                    ...
                    <h3 class="product-details-info-title"> Yoda Jewellery Prestashop Theme</h3>
...
<p>PSD and HTML has always been an excellent combination for building online versions of physical stores and jewellery shops are no exception. Successful jewellery shops are known for being stylish with a professional look that depicts the products being promoted. Whether you want to create a smalll website with a shopping cart or a large e-commerce store with a lot of functionality, YodaJewellery will help you achieve it. </p>
<p>YodaJewellery is a premium PSD HTML theme specially developed for creating powerful jewellery shops with a complete user friendly experience and a design that steals the show. It has a minimal texture and offers a scalable platform for selling your luxurious wares. A demo option is included to help you launch your shop in a few minutes. Various layouts are provided from which you can choose from to create stylish homepages that suits your needs. A simple drag and drop builder tool allows you to make exclusive changes to the demo layouts. You will also have access to page templates which can serve as blog sections, store pages and product sections.</p>
<p>A drag and drop page builder (visual composer) is added so that you can easily add any layout of your choice without writing any single code. You can equally customize the pages to meet you business needs using a host of elements provided, such as colours, structures, fonts (especially Google Web fonts), and image gallery amongst others. An elegant display for each product is added to enable customers to quickly get a glimpse of what you have in store. Various elements such as colours, font and structures are included to enable you customize the theme to your desired taste. However, always make sure, your final design meets your medical business needs.</p>
<p>There is nothing you wish for in a modern e-commerce shop online that you will not find in this powerful theme. In fact, there is no limit to how popular you can get. Why waste time. Unlock your potential with YodaJewellery now!</p>
...
If you are developer this template is ready for a CMS slice.
             ...
             <div class="quantity">
                        ...
                        <span class="text">Demo Theme</span>
                ...
                <div class="product-details-add-info">
                    ...
                    <div class="tags">Tags:
                        <a class="tags-item" href="#">SEO,</a>
                        <a class="tags-item" href="#">Books,</a>
                        <a class="tags-item" href="#">Marketing,</a>
                        <a class="tags-item" href="#">Strategy</a>
                    </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="product-description">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="product-description-text">Iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
                                    feugiat <span class="c-dark"> nulla facilisis at vero eros et accumsan</span> et iusto odio dignissim qui blandit
                                    praesent luptatum quam nunc putamus parum claram. Claritas est etiam processus dynamicus,
                                    qui sequitur mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam
                                    nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula quarta
                                ...
                                <ul class="list list--secondary mb60">
                                    <li>
                                        ...
                                        <a href="#">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
                                            nibh <span class="c-primary">euismod tincidunt;</span>
                                        </a>
                                    </li>

                                    <li>
                                        <i class="seoicon-check"></i>
                                        <a href="#">Mirum est notare quam littera gothica;
                                        </a>
                                    </li>

                                    <li>
                                        <i class="seoicon-check"></i>
                                        <a href="#">Claritas est etiam processus dynamicus sequitur;
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <i class="seoicon-check"></i>
                                        <a href="#">Investigationes demonstraverunt lectores.
                                        </a>
                                    </li>
                                </ul>
                            </div>

...
<meta name="msvalidate.01" content="E7265AF0DB2F209D64054FD000956E34" />
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <title>TEAMPRESTA.COM - Service Detail Social Media Marketing - PRESTASHOP 1.7 EXCLUSIVE THEMES, ADDONS and PREMIUM SUPPORT</title>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_8Zwv9yKXKg?rel=0" frameborder="0" allowfullscreen></iframe>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                    <div class="heading mb30">
                        ...
                        <h5 class="heading-subtitle">Social media marketing is the use of social media platforms and websites to promote a product or service. 
                        </h5>
                    ...
                    <a href="https://www.freelancer.com/u/sascristian" class="btn btn-medium btn--dark btn-hover-shadow mb30">
    ...
    <div class="row pt120">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="heading mb60">
                ...
                <h5 class="heading-subtitle">Social media itself is a catch-all term for sites that may provide radically different social actions.</h5>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="pie-chart-item">
                    ...
                    <div class="pie-chart-content">
                        ...
                        <p class="pie-chart-content-text">Brand monitoring, often referred to as social media listening, is essential to building relationships with consumers and protecting your brand’s reputation.
                        </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="pie-chart-item">
                    ...
                    <div class="pie-chart-content">
                        ...
                        <p class="pie-chart-content-text">You know that a contest or a campaign is something you want to do on social. But where do you start? 
                        </p>
                        <a href="#" class="more">Read More
                            <i class="seoicon-right-arrow"></i>
                        </a>
                ...
                <div class="pie-chart-item">
                    ...
                    <div class="pie-chart-content">
                        <h4 class="pie-chart-content-title">Social Media
                            Management</h4>
                        <p class="pie-chart-content-text">The only way to effectively manage social media at scale is with the use of social media management tools that can improve your efficiency.
                        </p>
                        <a href="#" class="more">Read More
                            <i class="seoicon-right-arrow"></i>
                        </a>
                ...
                <div class="pie-chart-item">
                    ...
                    <div class="pie-chart-content">
                        <h4 class="pie-chart-content-title">Setup & Custom
                            Profile Design</h4>
                        <p class="pie-chart-content-text">We create and customize Social media profiles with quality content and aesthetics that resonates with your brand and audience.
                        </p>
                        <a href="#" class="more">Read More
                            <i class="seoicon-right-arrow"></i>
                        </a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box--standard-centered">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text c-white">The idea of content marketing is to attract and retain customers by creating and curating relevant and valuable content.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box--standard-centered">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text c-white">Quality content is the number one driver of your search engine rankings and there is no substitute for great content.
                            </p>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="case-slider-item swiper-slide">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    <div class="testimonial-text">
                                        Excellent work. Completed project with minimal direction.
                                    </div>
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            ...
                                            <div class="author-company c-primary">Upwork Market</div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    <div class="testimonial-text">
                                        Great worker, completed the job by the deadline and was willing to push themself late hours to reach the deadline on time.
                                    </div>
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            ...
                                            <div class="author-company c-primary">hardjobs</div>
                                        </div>
                                    </div>
                        ...
                        <div class="case-slider-item swiper-slide">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    <div class="testimonial-text">
                                       He talked in terms I could understand and I believe has helped drive business to my site.
                                    </div>
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            <h6 class="author-name">Jonathan Simpson</h6>
                                            <div class="author-company c-primary">y8shop</div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    <div class="testimonial-text">
                                        Great experience. He helped me with SEO issues for my website.
                                    </div>
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            <h6 class="author-name">Angelina Johnson</h6>
                                            <div class="author-company c-primary">relmary</div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            <h6 class="author-name">Angelina Johnson</h6>
                                            <div class="author-company c-primary">a4webhosting</div>
                                        </div>
                                    </div>
                        ...
                        <div class="case-slider-item swiper-slide">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            <h6 class="author-name">Jonathan Simpson</h6>
                                            <div class="author-company c-primary">Ano</div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="testimonial-item testimonial-arrow mb30">
                                    <div class="testimonial-text">
                                        Working with them is great. They are very easy to talk too, as well as the ability to grasp your industry quickly. I very much recommend working with them.
                                    </div>
                                    ...
                                    <div class="author-info-wrap table">
                                        ...
                                        <div class="author-info table-cell">
                                            <h6 class="author-name">Angelina Johnson</h6>
                                            <div class="author-company c-primary">new8</div>
                                        </div>
                                    </div>

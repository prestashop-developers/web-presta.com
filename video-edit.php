...
<meta name="msvalidate.01" content="E7265AF0DB2F209D64054FD000956E34" />
    ...
    <title>TEAMPRESTA.COM - Video Edit & after effects THEMES, ADDONS and PREMIUM SUPPORT</title>
...
<div class="stunning-header stunning-header-bg-rose">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">Video Creations</h1>
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs-item active">
                <span href="#">Services - Video Creations</span>
                <i class="seoicon-right-arrow"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="row medium-padding120">
        ...
        <div class="col-lg-12">
            ...
            <div class="heading align-center">
                <h4 class="h1 heading-title">See  our Video Portfolio</h4>
            </div>
            ...
            <div class="row sorting-container" data-layout="fitRows">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big mb60">
                       ...
                       <iframe width="500" height="315" src="https://www.youtube.com/embed/pIfI1dBBwAM" frameborder="0" allowfullscreen></iframe>
                        </div>
                        <h5 class="case-item__title">Theme Description Video</h5>
                        <div class="case-item__cat">
                           <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <iframe width="500" height="315" src="https://www.youtube.com/embed/vled935DzN8" frameborder="0" allowfullscreen></iframe>
                        </div>
                       <h5 class="case-item__title">Spot Freelancer</h5>
                        <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <iframe width="500" height="315" src="https://www.youtube.com/embed/q7UWlwFgcPs" frameborder="0" allowfullscreen></iframe>
                        </div>
                         <h5 class="case-item__title">Theme Bundle Description Video</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                    ...
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <iframe width="500" height="315" src="https://www.youtube.com/embed/0VDkq9h4x5k" frameborder="0" allowfullscreen></iframe>
                        </div>
                         <h5 class="case-item__title">Screen Video Recorder</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                    ...
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <iframe width="500" height="315" src="https://www.youtube.com/embed/erCHCUf4_xQ" frameborder="0" allowfullscreen></iframe>
                        </div>
                         <h5 class="case-item__title">VIDEO ELEGANT RESUME</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                    ...
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <iframe width="500" height="315" src="https://www.youtube.com/embed/wNIzoDDVT3M" frameborder="0" allowfullscreen></iframe>
                        </div>
                         <h5 class="case-item__title">App Theme VIDEO Template</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
<iframe width="500" height="315" src="https://www.youtube.com/embed/PR7owov84sw" frameborder="0" allowfullscreen></iframe>
                        </div>
                         <h5 class="case-item__title">SEO Script Theme VIDEO Template 2</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
<iframe width="500" height="315" src="https://www.youtube.com/embed/7GESRFihiKQ" frameborder="0" allowfullscreen></iframe>                        </div>
                         <h5 class="case-item__title">Games Tournament Announcements </h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
<iframe width="500" height="315" src="https://www.youtube.com/embed/_o7cJxcgXH8" frameborder="0" allowfullscreen></iframe>                       </div>
                         <h5 class="case-item__title">Photo Effects Model +18 </h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
                            <a href="#">Afterr Effects,</a>
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
<iframe width="500" height="315" src="https://www.youtube.com/embed/2oJuY2xlkak" frameborder="0" allowfullscreen></iframe>                     </div>
                         <h5 class="case-item__title">Theme Description Video</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
<iframe width="500" height="315" src="https://www.youtube.com/embed/yLZ2eX3_TyA" frameborder="0" allowfullscreen></iframe>                    </div>
                         <h5 class="case-item__title">Theme Description Video</h5>
                        <div class="case-item__cat">
                            <div class="case-item__cat">
                            <a href="#">Video Template,</a>

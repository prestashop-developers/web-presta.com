...
<meta name="msvalidate.01" content="E7265AF0DB2F209D64054FD000956E34" />
    ...
    <title>TEAMPRESTA.COM- PRESTASHOP 1.7 EXCLUSIVE THEMES, ADDONS and PREMIUM SUPPORT</title>
...
<div class="stunning-header stunning-header-bg-rose">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">Prestashop Themes</h1>
        <ul class="breadcrumbs">
            ...
            <li class="breadcrumbs-item active">
                <span href="#">Prestashop Themes Club</span>
                <i class="seoicon-right-arrow"></i>
            </li>
        </ul>
    </div>
    ...
    <div class="row medium-padding120">
        ...
        <div class="col-lg-12">
            ...
            <div class="heading align-center">
                <h4 class="h1 heading-title">See all our Prestashop Exclusive Themes</h4>
            </div>
            ...
            <div class="row sorting-container" data-layout="fitRows">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                       <a href="hompage1e.html" class="">     <img src="img/s1e.png" alt="our case"></a>
                        </div>
                        <h5 class="case-item__title">Theme Home Page 1</h5>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                           <a href="hompage2e.html" class="">     <img src="img/s3e.png" alt="our case"></a>
                        </div>
                       <h5 class="case-item__title">Theme Home Page 2</h5>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">Fashion,</a>
                            <a href="#">PSD</a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <a href="hompage3e.html" class="">   <img src="img/s4e.png" alt="our case"></a>
                        </div>
                         <h5 class="case-item__title">Theme Home Page 3</h5>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">Glasses,</a>
                            <a href="#">PSD</a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                            <a href="hompage4e.html" class=""> <img src="img/s5e.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 4</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce</a>
                            <a href="#">PetShop</a>
                            <a href="#">PSD</a>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                        <a href="hompage5e.html" class="">     <img src="img/s2e.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 5</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">ClothesShop,</a>
                             <a href="#">PSD</a>
                            <a href="#">HTML</a>
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                             <a href="hompage6e.html" class="">  <img src="img/1se.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 6</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                           <a href="#">Ecommerce,</a>
                            <a href="#">ClothesShop2,</a>
                             <a href="#">PSD</a>
                            <a href="#">HTML</a>
                        </div>
                    </div>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                           <a href="hompage7e.html" class="">   <img src="img/2se.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 7</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">ToysShop,</a>
                             <a href="#">PSD</a>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                        <a href="hompage8e.html" class="">    <img src="img/3se.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 8</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">GymShop,</a>
                             <a href="#">PSD</a>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                          <a href="hompage9e.html" class="">   <img src="img/4se.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 9</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">MedicalShop,</a>
                             <a href="#">PSD</a>
                            <a href="#">HTML</a>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 sorting-item ecommerce ">
                    <div class="case-item align-center big  mb60">
                        <div class="case-item__thumb mouseover lightbox shadow animation-disabled">
                         <a href="hompage10e.html" class="">   <img src="img/5se.png" alt="our case"></a>
                        </div>
                        <h6 class="case-item__title">Theme Home Page 10</h6>
                        <div class="case-item__cat">
                            <a href="#">Ecommerce,</a>
                            <a href="#">JewelryShop,</a>
                          <a href="#">PSD</a>
                            <a href="#">HTML</a>

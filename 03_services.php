...
<meta name="msvalidate.01" content="E7265AF0DB2F209D64054FD000956E34" />
    ...
    <title>TEAMPRESTA.COM PRESTASHOP 1.7 THEMES - ADDONS and PREMIUM SUPPORT.</title>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/C6cwOkhvE8I" frameborder="0" allowfullscreen></iframe>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="services-main">
                <div class="heading">
                    ...
                    <p class="heading-text">We craft beautifully useful marketing and digital products that grow businesses!
                    </p>
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="servises-item bg-violet-color">
                ...
                <div class="servises-item__content">
                    ...
                    <p class="servises-text">We’re an SEO agency that runs successful SEO campaigns in the most competitive sectors.
                    </p>
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="servises-item bg-primary-color">
                ...
                <div class="servises-item__content">
                    ...
                    <p class="servises-text">Local SEO is a lot different from your SEO campaign,the local search results are changing rapidly than other.
                    </p>
                </div>
            ...
            <div class="servises-item bg-secondary-color">
                ...
                <div class="servises-item__content">
                    <h4 class="servises-title">Social Media
                        Marketing</h4>
                    <p class="servises-text">Social media marketing is the use of social media platforms and websites to promote a product or service.
                    </p>
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="servises-item bg-orange-color">
                ...
                <div class="servises-item__content">
                    ...
                    <p class="servises-text">Email marketing automation, is the act of sending a commercial message, typically to a group of people, using email.
                    </p>
                </div>
            ...
            <div class="servises-item bg-green-color">
                ...
                <div class="servises-item__content">
                    <h4 class="servises-title">Pay Per Click
                        Management</h4>
                    <p class="servises-text">Search engine advertising is one of the most popular forms of PPC, places advertisements in the search engine.  
                    </p>
                </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="features-item">
                      ...
                      <div class="features-content">
                        ...
                        <p class="features-text">Local SEO involves managing where customers find your company and ensures your company is featured with accurate information.
                        </p>
                      </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p class="features-text">Provides directions, interactive maps, and satellite/aerial imagery of many countries. Can also search by keyword such as type of business.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p class="features-text">Link building is still and will continue to be a tremendously important component of online marketing and the number one search engine.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p class="features-text">Paid search marketing is an inexpensive and scalable form of web marketing designed to connect your ads with searchers actively seeking what you provide.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p class="features-text">A Top Custom Web Design Business like us, can help you create a unique website for an affordable price.
                            </p>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p class="features-text">Let our expert email designers create the perfect responsive email design for your brand.
                            </p>
                        </div>
...
<div class="container pb120 pt120">
    <div class="row">
        <div class="col-lg-12">
            <div class="heading">
                <h4 class="h1 heading-title">Our Product Based Services</h4>
                <div class="heading-line">
                    <span class="short-line"></span>
                    <span class="long-line"></span>
                </div>
                <p class="heading-text c-dark">
We are key domain experts in PrestaShop programming and ecommerce web development. As a PrestaShop solutions agency we can help you out with module development, themes' integration and custom development. 
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row pb30">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <ul class="list list--secondary">
                <li>
                    ...
                    <a href="#">We have great knowledge, gained through many years of experience developing premium themes and addons.
                    </a>
                </li>
            </ul>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <ul class="list list--secondary">
                <li>
                    <i class="seoicon-check"></i>
                    <a href="#">We improve the quality of our products not only by optimizing them and increasing the number of features, but also increasing the speed and efficiency of the support services for our customers.
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 mb30">
            <a href="22_contacts.html" class="btn btn-medium btn--blue">
                <span class="text">Free SEO Consultation</span>
                <span class="semicircle"></span>
            </a>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 mb30">
            <a href="22_contacts.html" class="btn btn-medium btn--yellow">

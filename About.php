...
<script type="text/javascript" src="http://teampresta.com/livechat/php/app.php?widget-init.js"></script>
    ...
    <title>TEAMPRESTA - About Us - PRESTASHOP 1.7 EXCLUSIVE THEMES, ADDONS and PREMIUM SUPPORT</title>
    ...
    <div class="row pt120">
        <div class="col-lg-12">
            <div class="heading mb30">
                ...
                <h5 class="heading-subtitle">This is a short story about Teampresta.com's humble beginning in Prstashop website design
                </h5>
            </div>
        </div>

        <div class="col-lg-6">
            <p>Our primary and only reason for creating and establishing a PrestaShop website design business is to help small and medium sized businesses with their website design needs.
            </p>
        </div>

        <div class="col-lg-6">
            <p> Our small website design company has grown over the years with clients located all over the United States and the world.</p>
        </div>
                                ...
                                <div class="events-wrapper">
                                    <div class="events">
                                        <ol>
                                            ...
                                            <li><a href="#0" data-date="20/12/2017">2017</a></li>
                                            <!-- other dates here -->
                                        </ol>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-9 col-xs-12 table-cell">
                                                <div class="time-line-content">
                                                    ...
                                                    <p class="time-line-text">A company’s life cycle starts with foundation. Thus, the first entry in accounting is the formation of share capital. What else happens in accounting in addition to the increase of capital, depends on the agreements between shareholders made upon foundation of the company. We created the Teampresta with the vision of helping make the Ecommerce world better.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-9 col-xs-12 table-cell">
                                                <div class="time-line-content">
                                                    ...
                                                    <h5 class="time-line-title">punching WorldWide</h5>
                                                    <p class="time-line-text">We got our business extended!!
We joined the premium web design communities worldwide. We started our first digital products selling with our vendor partners.
And increase our projects rates buy joing in the freelancer Outsourcing.
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-9 col-xs-12 table-cell">
                                                <div class="time-line-content">
                                                    ...
                                                    <h5 class="time-line-title">Prestashop Framework development</h5>
                                                    <p class="time-line-text">We started building and upgrading our exclusive CMS premium framework and addons.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-lg-offset-1 col-md-8 col-md-offset-1 col-sm-9 col-xs-12 table-cell">
                                                <div class="time-line-content">
                                                    ...
                                                    <h5 class="time-line-title">We launched other premium web CMS frameworks and theme marketplaces</h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-md-offset-1 col-sm-12 col-xs-12 col-lg-offset-1 table-cell">
                                                <div class="time-line-content">
                                                    ...
                                                    <h5 class="time-line-title">Increasing themes and addons libraries</h5>
                                                    <p class="time-line-text">
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <li data-date="20/12/2016">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-md-offset-1 col-sm-12 col-xs-12 col-lg-offset-1 table-cell">
                                                <div class="time-line-content">
                                                    <h6 class="time-line-subtitle">Dec, 2017</h6>
                                                    <h5 class="time-line-title">Foundation of the Company</h5>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="slider-profit swiper-slide">
                        <div class="row medium-padding120">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title c-white mb30">Wordpress Premium Themes</h4>
                                    <p class="c-white">We Work for Your Profit - <a href="https://apartner.pro/?s=wordpress_themes/">Premium Wordpress Themes</a> 
                                    </p>
                                </div>
                    ...
                    <div class="slider-profit swiper-slide">
                        <div class="row medium-padding120">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title c-white mb30">Magento Premium Themes</h4>
                                    <p class="c-white">We Work for Your Profit - <a href="http://thememagento.com/">Premium Magento Themes</a> 
                                    </p>
                                </div>
    ...
    <div class="row pt120 mb30">
        ...
        <div class="col-lg-12">
            <div class="heading align-center">
                <h4 class="h1 heading-title">Meet with Our Best Prestashop Experts</h4>
                <div class="heading-line">
                    <span class="short-line"></span>
                    <span class="long-line"></span>
                </div>
                <p class="heading-text">Meet experienced team of Teampresta experts from a variety of engineering and IT skills! </p>
            </div>
        </div>
    ...
    <div class="row pb120">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="teammembers-item">
                ...
                <h5 class="teammembers-item-name">Adrian Sas</h5>
                <p class="teammembers-item-prof">CEO&FOUNDER</p>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="teammembers-item">
                ...
                <h5 class="teammembers-item-name">Cristian Sas</h5>
                <p class="teammembers-item-prof">CEO&FOUNDER</p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                    <div class="info-box--standard">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text">In order to succeed with your marketing, you need tools for support. One of our greatest superpower is the power of SUPPORT.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                    <div class="info-box--standard">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text">We are committed to offering the right level of superpower support to all our members. 
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                        <div class="heading align-center">
                            ...
                            <p class="heading-text c-white">Make Ecommerce safe, accessible and affordable.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="case-slider-item swiper-slide">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="testimonial-item testimonial-arrow mb30">
                                        <div class="testimonial-text">
                                            The best Prestashop web design agency ever!!
                                        </div>
                                        ...
                                        <div class="author-info-wrap table">
                                            ...
                                            <div class="author-info table-cell">
                                                ...
                                                <div class="author-company c-primary">EMarket</div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="testimonial-item testimonial-arrow mb30">
                                        <div class="testimonial-text">
                                            I will definitely recommend you guys from now on.
                                        </div>
                                        ...
                                        <div class="author-info-wrap table">
                                            ...
                                            <div class="author-info table-cell">
                                                ...
                                                <div class="author-company c-primary">Ptcn</div>
                                            </div>
                                        </div>
...
<div class="container">
    <div class="row medium-padding120">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <div class="heading">
                <h4 class="h1 heading-title">Our Valuable Vendors</h4>
                <div class="heading-line">
                    <span class="short-line"></span>
                    <span class="long-line"></span>
                </div>
                <p class="heading-text">We have future product items all over the online community marketplaces! Find us on :
                </p>
            </div>

            <a href="09_our_clients.html" class="btn btn-medium btn--dark mb30">
                <span class="text">View all Partners</span>
                <span class="semicircle"></span>
            </a>
        </div>

...
<meta name="msvalidate.01" content="E7265AF0DB2F209D64054FD000956E34" />
    ...
    <title>TEAMPRESTA.COM - Contacts Page - PRESTASHOP 1.7 EXCLUSIVE THEMES, ADDONS and PREMIUM SUPPORT</title>
    ...
    <div class="row pt120 pb80">
        <div class="col-lg-12">
            <div class="heading">
                ...
                <p class="heading-text">Contact us today for a competitive quote for your Prestashop web design project, graphic design and social media management work.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="contacts">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">Cluj Napoca, Romania</a>
                                <p class="sub-title">795 Marasti Avenue</p>
                            </div>
                        </div>
                    </div>
